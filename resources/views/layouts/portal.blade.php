            ...
            <nav class="flex-1 px-3 py-4 space-y-1">
                ...
                if (auth()->user()->hasRole('dosen')) {
                    ...
                    $menu = [
                        ...
                        ['label' => 'Program Studi', 'route' => '#', 'icon' => 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.42A12.02 12.02 0 0112 21.5a12.02 12.02 0 01-6.16-10.92L12 14z'],
                        ['label' => 'Mata Kuliah', 'route' => '#', 'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
                    ...
                    if (auth()->user()->program_studi_id) {
                        $menu = [
                            ...
                            ['label' => 'Jelajahi Kelas', 'route' => 'mahasiswa.jelajahi-kelas', 'icon' => 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z'],
                ...
                <div class="pt-4 mt-4 border-t border-gray-100 space-y-1">
                    <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
