...
<body class="font-sans antialiased bg-gray-50">
    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        ...
        <!-- Sidebar -->
        <aside class="fixed h-screen flex flex-col transition-all duration-300 overflow-hidden"
            style="background-color: {{ $sidebarBg }}; border-right: 1px solid {{ $sidebarBorder }};"
...
=======
        <div class="flex-1 transition-all duration-300" :class="sidebarOpen ? 'ml-64' : 'ml-0'">
            <!-- Topbar -->
            <header class="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between gap-4">
                <button @click="sidebarOpen = !sidebarOpen" class="w-9 h-9 rounded-lg border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-50 transition">
>>>>>>> 8fb30f0 (feat: perbaikan form NIM mahasiswa, reset password via Gmail, dan fitur absensi)
