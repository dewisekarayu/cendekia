...
<body class="font-sans antialiased bg-gray-50 text-gray-800">
    <div class="h-screen w-screen flex overflow-hidden">
        ...
        <aside class="w-64 bg-white border-r border-gray-100 flex flex-col shrink-0 h-full">
            <div class="px-6 py-5 border-b border-gray-100 shrink-0">
                <a href="/" class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-lg bg-[#002B6B] flex items-center justify-center shrink-0 shadow-sm">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="text-base font-bold text-[#002B6B] leading-none truncate">Cendekia</div>
                        <div class="text-[11px] text-gray-400 font-medium leading-none mt-1 truncate">Academic Portal</div>
                    </div>
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                @php
                    ...
                    if ($user->hasRole('dosen')) {
                        ...
                        $menu = [
                            ...
                            ['label' => 'Dosen & Mahasiswa', 'route' => 'admin.user.index', 'icon' => 'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-4a4 4 0 10-8 0 4 4 0 008 0zm6 0a4 4 0 10-8 0 4 4 0 008 0z'],
                ...
                <div class="pt-4 mt-4 border-t border-gray-100 space-y-1">
                    <a href="{{ route('mahasiswa.setting') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition {{ request()->routeIs('mahasiswa.setting') ? 'bg-[#002B6B] text-white' : 'text-gray-600 hover:bg-gray-100' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-100 px-8 h-16 flex items-center justify-end gap-4 shrink-0">
                <button class="relative w-9 h-9 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-50 shrink-0">
                ...
                <div class="flex items-center gap-2 bg-gray-50 rounded-full pl-1 pr-4 py-1 max-w-[200px] shrink-0">
                    <div class="w-7 h-7 rounded-full bg-[#002B6B] flex items-center justify-center text-white text-xs font-semibold shrink-0">
