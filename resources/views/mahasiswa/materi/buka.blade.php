...
{{-- ===== BREADCRUMB / BACK ===== --}}
    <div class="mb-4">
        <a href="{{ route('mahasiswa.kelas-detail', $kelas->id) }}?tab=materi"
            ...
            @if ($materi->files->isNotEmpty())
                ...
                @foreach ($materi->files as $file)
                    ...
                    <div class="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <a href="{{ route('mahasiswa.materi.preview', [$kelas->id, $materi->id, $file->id]) }}" target="_blank" class="min-w-0 flex-1 group">
                        ...
                        <a href="{{ route('mahasiswa.materi.unduh', [$kelas->id, $materi->id, $file->id]) }}"
                        title="Unduh file"
