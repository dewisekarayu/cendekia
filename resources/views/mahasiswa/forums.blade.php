...
@endphp
    ...
    <div class="forum-header">
        ...
        <a href="{{ route('mahasiswa.kelas-detail', $activeForum->kelas_perkuliahan_id) }}" class="forum-header-btn">
    ...
    <div class="forum-input-bar">
        ...
        <form id="chatForm" method="POST"
              action="{{ route('mahasiswa.kelas-forum.pesan', ['id' => $kelas->id, 'forum' => $activeForum->id]) }}"
              class="forum-form">
            @csrf
...
@else
    ...
    <div class="forum-placeholder">
        ...
        <p class="forum-placeholder-sub">Pilih kelas dari panel kiri untuk mulai berdiskusi.</p>
    </div>
@endif
