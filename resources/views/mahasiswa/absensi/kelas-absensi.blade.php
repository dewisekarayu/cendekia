    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="min-w-0">
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
                <a href="{{ route('mahasiswa.absensi.index') }}" class="hover:text-gray-900 transition">Daftar Kelas</a>
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/></svg>
                <span class="text-gray-900 font-medium truncate">Presensi</span>
            </div>
            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 flex items-center gap-3 mt-2">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            <a href="{{ route('mahasiswa.absensi.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-medium transition">
                    ...
                    <div class="px-5 sm:px-6 py-5">
                        ...
                        <div class="bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200 mb-5">
                            @if($sudahAbsen)
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="font-bold text-green-900 text-sm sm:text-base">Anda Sudah Melakukan Presensi</p>
                            ...
                            @else
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-bold text-indigo-900 text-sm sm:text-base">Sesi Masih Terbuka</p>
                                        <p class="text-xs text-indigo-700 mt-0.5">Lakukan presensi sekarang jika Anda hadir di kelas</p>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        @if(!$sudahAbsen)
                            <form action="{{ route('mahasiswa.absensi.masuk', ['kelasId' => $kelas->id, 'absensiId' => $absensiAktif->id]) }}" method="POST" x-data="{ status: 'hadir' }" class="space-y-5">
                                ...
                                <div>
                                    <label class="block text-xs font-bold text-gray-900 mb-3 flex items-center gap-1.5">
                                    ...
                                    <div class="grid grid-cols-3 gap-2.5">
                                        ...
                                        <label class="cursor-pointer group">
                                            ...
                                            <div class="relative p-3 rounded-xl border-2 border-gray-200 peer-checked:border-green-500 peer-checked:bg-gradient-to-b peer-checked:from-green-50 peer-checked:to-emerald-50 hover:border-green-300 transition-all duration-200 shadow-sm">
                                                <div class="text-center">
                                                    <div class="w-9 h-9 rounded-full bg-green-100 group-hover:bg-green-200 peer-checked:bg-green-600 flex items-center justify-center mx-auto mb-1.5 transition-colors">
                                                        <svg class="w-5 h-5 text-green-600 peer-checked:text-white transition-colors" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                                        </svg>
                                                    </div>
                                                    <span class="text-xs sm:text-sm font-bold text-gray-800 peer-checked:text-green-700 transition-colors block">Hadir</span>
                                                    <span class="text-[10px] text-gray-500 peer-checked:text-green-600 mt-0.5 block">Saya hadir</span>
                                                </div>
                                            </div>
                                        </label>
                                        ...
                                        <label class="cursor-pointer group">
                                            ...
                                            <div class="relative p-3 rounded-xl border-2 border-gray-200 peer-checked:border-blue-500 peer-checked:bg-gradient-to-b peer-checked:from-blue-50 peer-checked:to-indigo-50 hover:border-blue-300 transition-all duration-200 shadow-sm">
                                                <div class="text-center">
                                                    <div class="w-9 h-9 rounded-full bg-blue-100 group-hover:bg-blue-200 peer-checked:bg-blue-600 flex items-center justify-center mx-auto mb-1.5 transition-colors">
                                                    ...
                                                    <span class="text-xs sm:text-sm font-bold text-gray-800 peer-checked:text-blue-700 transition-colors block">Izin</span>
                                                    <span class="text-[10px] text-gray-500 peer-checked:text-blue-600 mt-0.5 block">Tidak hadir</span>
                                                </div>
                                            </div>
                                        </label>
                                        ...
                                        <label class="cursor-pointer group">
                                            ...
                                            <div class="relative p-3 rounded-xl border-2 border-gray-200 peer-checked:border-yellow-500 peer-checked:bg-gradient-to-b peer-checked:from-yellow-50 peer-checked:to-amber-50 hover:border-yellow-300 transition-all duration-200 shadow-sm">
                                                <div class="text-center">
                                                    <div class="w-9 h-9 rounded-full bg-yellow-100 group-hover:bg-yellow-200 peer-checked:bg-yellow-600 flex items-center justify-center mx-auto mb-1.5 transition-colors">
                                                    ...
                                                    <span class="text-xs sm:text-sm font-bold text-gray-800 peer-checked:text-yellow-700 transition-colors block">Sakit</span>
                                                    <span class="text-[10px] text-gray-500 peer-checked:text-yellow-600 mt-0.5 block">Tidak sehat</span>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div x-show="status === 'izin' || status === 'sakit'" x-cloak class="animate-in fade-in duration-200">
                                    <label for="keterangan" class="block text-xs font-bold text-gray-900 mb-1.5 flex items-center gap-1.5">
                                    ...
                                    <textarea
                                        ...
                                        class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition resize-none shadow-sm @error('keterangan') border-red-500 @enderror">
                                    </textarea>
                                    @error('keterangan')
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-gray-600 font-medium text-sm">Anda sudah melakukan presensi untuk sesi ini</p>
                                <p class="text-xs text-gray-500 mt-1">Terima kasih telah melakukan presensi tepat waktu</p>
                            </div>
                        @endif
                    </div>
                </div>
            @else
                <div class="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border-2 border-dashed border-gray-300 p-8 text-center shadow-sm hover:shadow-md transition">
                    <div class="w-14 h-14 rounded-full bg-gray-200 flex items-center justify-center mx-auto mb-4">
                        <svg class="w-7 h-7 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">Tidak Ada Sesi Presensi Aktif</h3>
                    <p class="text-gray-600 mb-3 text-sm">Sesi presensi belum dibuka oleh dosen untuk hari ini.</p>
                    <p class="text-xs text-gray-500">Silakan cek kembali nanti atau hubungi dosen Anda.</p>
                </div>
            @endif

            <!-- Class Info Card -->
            <div class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                <div class="bg-gradient-to-r from-slate-50 to-slate-100 px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div class="px-6 py-5">
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-5">
                        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4 border border-indigo-200">
                            <p class="text-indigo-600 text-xs font-bold uppercase tracking-wide mb-1">Pengajar</p>
                            <p class="font-bold text-gray-900 truncate" title="{{ $kelas->dosen->name }}">{{ $kelas->dosen->name }}</p>
                        </div>
                        <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-4 border border-cyan-200">
                            <p class="text-cyan-600 text-xs font-bold uppercase tracking-wide mb-1">Ruangan</p>
                            <p class="font-bold text-gray-900">{{ $kelas->ruangan ?? '—' }}</p>
                        </div>
                        <div class="bg-gradient-to-br from-lime-50 to-lime-100 rounded-xl p-4 border border-lime-200">
                            <p class="text-lime-600 text-xs font-bold uppercase tracking-wide mb-1">Hari</p>
                            <p class="font-bold text-gray-900">{{ $kelas->hari ?? '—' }}</p>
                        </div>
                        <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-4 border border-pink-200 md:col-span-2">
                            <p class="text-pink-600 text-xs font-bold uppercase tracking-wide mb-1">Jam Kuliah</p>
                            <p class="font-bold text-gray-900">{{ $kelas->jam_mulai }} - {{ $kelas->jam_selesai }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-4">
            @if($riwayatAbsensi->count() > 0)
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h3 class="font-bold text-gray-900">Presensi 5 Terakhir</h3>
                    </div>
                    <div class="p-4 space-y-2">
                        @foreach($riwayatAbsensi->take(5) as $absensi)
                            @php $attendance = $absensi->absensiMahasiswa->first(); @endphp
                            <div class="flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100 hover:from-slate-100 hover:to-slate-200 transition">
                                <div class="min-w-0">
                                    <p class="text-sm font-bold text-gray-900">Pertemuan {{ $absensi->pertemuan_ke }}</p>
                                    <p class="text-xs text-gray-500 mt-0.5">{{ $absensi->tanggal->format('d M Y') }}</p>
                                </div>
                                @if($attendance)
                                    <span @class([
            ...
            <!-- Quick Tips -->
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border border-indigo-200 p-5 shadow-sm hover:shadow-md transition">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-bold text-indigo-900 mb-2">Tips Presensi</h4>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div class="p-4 space-y-3">
                    <div class="flex items-center justify-between p-2">
                        <span class="text-sm font-medium text-gray-600">Lihat Riwayat Lengkap</span>
