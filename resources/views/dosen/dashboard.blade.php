...
@section('content')
    ...
    <div class="bg-[#321270] rounded-xl px-8 py-6 relative overflow-hidden mb-8">
        <div class="relative z-10">
            ...
            <p class="text-white text-sm mt-1 max-w-md">
                You have {{ $kelasList->count() }} classes this semester and {{ $tugasPerluDinilai }} assignments waiting to be graded.
            </p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="absolute -right-4 -bottom-6 w-32 h-32 text-[#321270]/80 opacity-60" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div class="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
            <div class="flex items-center gap-4">
                <div class="w-11 h-11 rounded-lg bg-[#321270]/10 flex items-center justify-center text-[#321270] shrink-0">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('dosen.kelas-saya') }}" class="text-sm font-medium text-[#321270] hover:underline">View All →</a>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach ($kelasList as $i => $kelas)
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div class="p-5">
                            <span class="inline-block text-[10px] font-semibold tracking-wide text-[#321270] bg-[#321270]/10 px-2 py-0.5 rounded mb-2">
                            ...
                            <a href="{{ route('dosen.kelas-detail', $kelas->id) }}" class="mt-4 block text-center bg-[#321270] hover:bg-[#321270]/90 text-white text-sm font-medium py-2 rounded-lg transition">
                                Manage Class
                            </a>
                        </div>
                    </div>
                        ...
                        <tr class="border-b border-gray-50 last:border-0">
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-2.5">
                                    <div class="w-8 h-8 rounded-full bg-[#321270] flex items-center justify-center text-white text-xs font-semibold shrink-0">
                            ...
                            <td class="px-5 py-3">
                                <p class="font-medium text-[#321270]">{{ $item->tugas?->judul ?? '-' }}</p>
                            ...
                            <td class="px-5 py-3 text-right">
                                <a href="#" class="inline-block text-xs font-medium text-[#321270] bg-[#321270]/10 hover:bg-[#321270]/20 px-3 py-1.5 rounded-md transition">
                                    Grade Now
                                </a>
                            </td>
                        </tr>
