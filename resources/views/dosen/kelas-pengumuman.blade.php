...
@section('content')
    ...
    <div class="flex items-center gap-0 mb-6 border-b border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg transition-colors duration-200">
        ...
        <a href="{{ route('dosen.forums') }}" class="flex items-center gap-2 px-5 py-3.5 text-sm font-semibold text-gray-500 dark:text-gray-400 border-b-2 border-transparent text-decoration-none white-space-nowrap transition duration-200 hover:text-slate-800 dark:hover:text-white opacity-70">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
