...
{{-- HEADER --}}
<div class="mb-5 overflow-hidden rounded-2xl bg-gradient-to-br from-[#321270] to-[#4a1fa8] px-6 py-6 sm:px-8 shadow-lg relative">
...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
            <h2 class="mb-3 text-sm font-bold text-gray-800">Deskripsi Mata Kuliah</h2>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                <h3 class="mb-3 text-sm font-bold text-gray-800">Capaian Pembelajaran</h3>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex gap-2"><span class="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#321270]"></span>Mampu menganalisis konsep dasar mata kuliah ini</li>
                    <li class="flex gap-2"><span class="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#321270]"></span>Mampu mengimplementasikan teori ke praktik</li>
                </ul>
            </div>
            <div class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                <h3 class="mb-3 text-sm font-bold text-gray-800">Quick Actions</h3>
                <div class="space-y-2">
                    <a href="{{ route('dosen.kelas-materi', $kelas->id) }}" class="flex items-center gap-2.5 rounded-xl border border-gray-100 p-3 text-xs font-semibold text-gray-700 hover:border-[#321270] hover:bg-purple-50/40 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#321270]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
                        Tambah Materi
                    </a>
                    <a href="{{ route('dosen.kelas-tugas', $kelas->id) }}" class="flex items-center gap-2.5 rounded-xl border border-gray-100 p-3 text-xs font-semibold text-gray-700 hover:border-amber-400 hover:bg-amber-50/40 transition">
                    ...
                    <a href="{{ route('dosen.gradebook', ['kelas_id' => $kelas->id]) }}" class="flex items-center gap-2.5 rounded-xl border border-gray-100 p-3 text-xs font-semibold text-gray-700 hover:border-emerald-400 hover:bg-emerald-50/40 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Input Nilai
                    </a>
                    <a href="{{ route('dosen.absensi.index', $kelas->id) }}" class="flex items-center gap-2.5 rounded-xl border border-gray-100 p-3 text-xs font-semibold text-gray-700 hover:border-blue-400 hover:bg-blue-50/40 transition">
    ...
    <div class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm h-fit">
        <h3 class="mb-4 text-sm font-bold text-gray-800">Info Kelas</h3>
        <div class="space-y-3 text-xs">
            @foreach ([
                ...
                <div class="flex items-center gap-2.5">
                    <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#321270]/8 text-[#321270]">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="font-semibold text-slate-700 truncate">{{ $info['value'] }}</p>
                    </div>
                </div>
            @endforeach
        </div>
