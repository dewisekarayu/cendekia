            ...
            <div class="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
                ...
                <div class="relative px-5 pb-5">
                    <div class="mb-4 -mt-12 flex items-end justify-between">
                        ...
                        <a href="#" class="inline-flex items-center gap-1.5 rounded-lg bg-[#321270] px-4 py-2 text-xs font-semibold text-white hover:bg-[#321270]/90 transition">
                    ...
                    <div class="mt-4 space-y-3 border-t border-gray-100 pt-4">
                        @php
                            $stats = [
                                ['label' => 'Kelas Diampu', 'value' => $user->kelasDiampu?->count() ?? 0],
