...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500 mt-1">Manage and access all your teaching classes this semester.</p>
</div>

<!-- Filter Row -->
<div class="flex flex-col sm:flex-row gap-3 mb-6">
    <select class="text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 text-gray-600 py-2.5">
    ...
    <div class="relative flex-1 max-w-sm">
        ...
        <input type="text" placeholder="Cari nama kelas..." class="w-full pl-9 text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 py-2.5">
    </div>
</div>
