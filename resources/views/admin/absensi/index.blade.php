...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-gray-500">Kelola semua sesi presensi di seluruh kelas</p>
        </div>
        <a href="{{ route('admin.absensi.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg font-semibold transition shadow-sm">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm p-5">
            <div class="flex items-end justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-700">{{ $statistics['total'] }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200 shadow-sm p-5">
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-xs text-gray-600 font-medium mb-1">Draft</p>
                    <p class="text-3xl font-bold text-yellow-700">{{ $statistics['draft'] }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200 shadow-sm p-5">
            <div class="flex items-end justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-700">{{ $statistics['buka'] }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl border border-red-200 shadow-sm p-5">
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-xs text-gray-600 font-medium mb-1">Ditutup</p>
                    <p class="text-3xl font-bold text-red-700">{{ $statistics['tutup'] }}</p>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Dosen</th>
                        ...
                        @foreach($absensiList as $absensi)
                            <tr class="hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    {{ $absensi->kelasPerkuliahan->dosen->name }}
                                </td>
                                <td class="px-6 py-4">
                                    <span @class([
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.absensi.show', $absensi->id) }}"
                                            class="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg text-xs font-semibold transition">
                                        ...
                                        <a href="{{ route('admin.absensi.edit', $absensi->id) }}"
                                            class="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-xs font-semibold transition">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 mb-4 font-medium">Belum ada sesi presensi.</p>
                <a href="{{ route('admin.absensi.create') }}" class="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white rounded-lg font-semibold transition shadow-md">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
