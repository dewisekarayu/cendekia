...
<div class="container-fluid py-4">
    <div class="import-wrapper">
        <div class="page-header">
            ...
            <a href="{{ route('admin.dosen.index') }}" class="btn btn-light border fw-bold text-secondary shadow-sm rounded-pill px-3">
        ...
        <div class="step-card">
            <div class="step-header">
                ...
                <div>
                    ...
                    <a href="data:text/csv;charset=utf-8,Nama Lengkap,NIP,Email,ID Program Studi%0AProf. Budi,19790001,budi@dosen.cendekia.ac.id,1" download="template_dosen.csv" class="btn-purple-outline">
                    ...
                    <div class="sop-grid">
                        <div class="sop-box">
                            ...
                            <div class="pt-3 text-slate-500" style="font-size: 0.8rem; line-height: 1.5;">
                                <i class="bi bi-shield-check text-emerald-500 me-1"></i> NIP juga akan otomatis dijadikan sebagai <strong>Password</strong> login awal akun.
                            </div>
                        </div>
