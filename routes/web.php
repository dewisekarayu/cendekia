...
Route::middleware(['auth', 'role:dosen'])->group(function () {
    ...
    Route::post('/dosen/ai-assistant/generate-pengumuman', [DosenAiAssistantController::class, 'generatePengumuman'])->name('dosen.ai-assistant.generate-pengumuman');
    Route::post('/dosen/ai-assistant/generate-dashboard-insight', [DosenAiAssistantController::class, 'generateDashboardInsight'])->name('dosen.ai-assistant.generate-dashboard-insight');
