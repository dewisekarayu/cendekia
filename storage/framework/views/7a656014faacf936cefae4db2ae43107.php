...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Cendekia')); ?></title>
            ...
            <div class="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
                <a href="/" class="flex items-center gap-2">
                    <div class="w-9 h-9 rounded-full bg-[#fffff] flex items-center justify-center relative shadow-sm">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Ilustrasi Edukasi" class="">
                    </div>
                ...
                <div class="hidden md:flex flex-1 justify-end items-center pr-12">
                    <div id="nav-container" class="relative flex items-center gap-8 text-[15px] font-semibold text-gray-500 py-2">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="nav-link text-[#0f2c59] font-bold pb-1">Dashboard</a>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="bg-blue-600 hover:bg-[#0a1f3f] text-white text-sm font-black md:font-semibold px-6 py-2.5 rounded-md transition shadow-sm">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="bg-blue-600 hover:bg-[#0a1f3f] text-white text-sm font-semibold px-6 py-2.5 rounded-md transition shadow-sm">
                            Sign In
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <main class="max-w-4xl mx-auto px-6 py-10 flex flex-col items-center justify-center">
            <div class="w-full flex flex-col items-center">
                ...
                <div class="w-full max-w-xl md:max-w-4xl -mt-15 animate-fade-in-up">
                    <img src="<?php echo e(asset('images/belajar2.png')); ?>" alt="Ilustrasi Edukasi" class="w-full h-auto object-contain">
                </div>

                <div class="w-full flex justify-center -mt-20 animate-fade-in-up">
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-3 bg-blue-600 hover:bg-[#0a1f3f] text-white font-semibold text-base px-8 py-4 rounded-xl shadow-xl shadow-blue-900/30 transition transform hover:-translate-y-0.5">
...
</html><?php /**PATH C:\laragon\www\cendekia\resources\views/welcome.blade.php ENDPATH**/ ?>