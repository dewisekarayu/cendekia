...
document.addEventListener('alpine:init', () => {
    Alpine.data('calendar', () => ({
        ...
        selectedSemesterId: "<?php echo e($selectedSemesterId ?? ''); ?>",
        ...
        updateURL() {
            ...
            window.location.href = `<?php echo e(route('mahasiswa.kalender-akademik.index')); ?>?${params.toString()}`;
        },
...
<?php /**PATH D:\laragon\www\cendekia\resources\views/mahasiswa/kalender-akademik/calendar-script.blade.php ENDPATH**/ ?>