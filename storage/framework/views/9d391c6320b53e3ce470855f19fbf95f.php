    ...
    <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $mataKuliah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td style="padding: 1.25rem 1.5rem; font-weight: 700; color: #002B6B;"><?php echo e($mk->kode_mk); ?></td>
                    <td style="padding: 1.25rem 1.5rem; font-weight: 600;"><?php echo e($mk->nama_mk); ?></td>
                    <td style="padding: 1.25rem 1.5rem; color: #475569;">
                        <?php echo e($mk->programStudi->nama_prodi ?? '-'); ?>

                    </td>
                    <td style="padding: 1.25rem 1.5rem; text-align: center;">
                        <div class="d-flex justify-content-center gap-2">
                            <a href="<?php echo e(route('admin.mata-kuliah.edit', $mk->id)); ?>" class="btn btn-sm btn-light border text-primary p-1.5 px-2" title="Edit" style="border-radius: 6px; color: #002B6B !important;">
                                <i class="bi bi-pencil"></i>
                            </a>

                            <form action="<?php echo e(route('admin.mata-kuliah.destroy', $mk->id)); ?>" method="POST" style="display:inline-block;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mata kuliah ini?')">
                                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\cendekia\resources\views/admin/mata-kuliah/table.blade.php ENDPATH**/ ?>