    ...
    <div class="admin-topbar-right">
        ...
        <div class="dropdown">
            <div class="admin-topbar-profile" data-bs-toggle="dropdown">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=<?php echo e(auth()->user()->name); ?>"
...
<?php /**PATH D:\laragon\www\cendekia\resources\views/admin/components/topbar.blade.php ENDPATH**/ ?>