    ...
    <div class="cnd-login-box">
        ...
        <div class="cnd-card">
            ...
            <?php if(session('status')): ?>
                <div class="cnd-alert cnd-alert-success"><?php echo e(session('status')); ?></div>
            <?php endif; ?>
            ...
            <?php if($errors->any()): ?>
                <div class="cnd-alert cnd-alert-error">
                    ...
                    <p style="margin: 0;"><?php echo e($errors->first('credential') ?: ($errors->first('password') ?: 'Login gagal, periksa kembali kredensial Anda')); ?></p>
                </div>
            <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="cnd-error-text"><?php echo e($message); ?></p>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="cnd-field">
                    <div style="display: flex !important; align-items: center; justify-content: space-between; margin-bottom: 8px;">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="cnd-forgot-link">Lupa Password?</a>
                    </div>
                    <div class="cnd-input-wrap">
                        <div class="cnd-input-icon">
                            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        />
                        <button type="button" id="togglePassword" class="cnd-toggle-pw" aria-label="Tampilkan password">
                            
                            <svg id="eyeOpen" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="display: block;">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                            
                            <svg id="eyeClose" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="display: none;">
...
<?php endif; ?><?php /**PATH D:\laragon\www\cendekia\resources\views/auth/login.blade.php ENDPATH**/ ?>