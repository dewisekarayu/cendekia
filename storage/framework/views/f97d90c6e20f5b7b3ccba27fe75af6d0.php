<?php $__env->startSection('title', $kelas->mataKuliah->nama_mk ?? 'Materi Kelas'); ?>
    ...
    <div class="bg-gradient-to-r from-[#321270] to-[#4c19a0] dark:from-indigo-950 dark:to-purple-900 rounded-xl px-8 py-6 mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm">
        <div>
            <div class="flex items-center gap-2 mb-2">
                <span class="text-xs font-semibold bg-white/15 text-white px-2.5 py-1 rounded"><?php echo e($kelas->mataKuliah->kode_mk ?? '-'); ?></span>
                <span class="text-xs text-white/80">Semester <?php echo e($kelas->semester->nama_semester ?? '-'); ?></span>
            </div>
            <h1 class="text-xl font-bold text-white"><?php echo e($kelas->mataKuliah->nama_mk ?? '-'); ?></h1>
            <p class="text-sm text-white/80 mt-1">
                <?php echo e($kelas->hari); ?>, <?php echo e($kelas->jam_mulai); ?> - <?php echo e($kelas->jam_selesai); ?> • <?php echo e($kelas->ruangan); ?>
...
<?php endif; ?>
    ...
    <div class="mb-5 flex items-center gap-1 overflow-x-auto rounded-2xl border border-slate-200/80 dark:border-slate-700 bg-white dark:bg-slate-800 p-1.5 shadow-sm transition-colors duration-200">
        <?php $__currentLoopData = $tabLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-2.5">
                        ...
                        <div class="relative w-full xs:w-auto sm:w-44">
                            <select id="filterPertemuan"
                                class="w-full h-10 pl-3 pr-8 text-sm border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none appearance-none transition">
                                <option value="">Semua Pertemuan</option>
                                <?php for($i = 1; $i <= 16; $i++): ?>
                                    <option value="<?php echo e($i); ?>">Pertemuan <?php echo e($i); ?></option>
                                <?php endfor; ?>
                            </select>
                    ...
                    <div id="materiListWrapper" class="space-y-4">
                        <?php $__currentLoopData = $materiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="materi-card p-5 border border-gray-100 dark:border-slate-700/60 bg-slate-50/30 dark:bg-slate-900/10 rounded-xl hover:shadow-md hover:border-purple-200 dark:hover:border-purple-900/50 transition-all duration-200"
                                data-search="<?php echo e(strtolower($m->judul . ' ' . ($m->deskripsi ?? '') . ' ' . ($m->kategori ?? '') . ' pertemuan ' . $m->pertemuan_ke)); ?>"
                                data-pertemuan="<?php echo e($m->pertemuan_ke); ?>">
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    ...
                                    <div class="min-w-0 flex-1 space-y-2">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-purple-50 dark:bg-purple-950/60 text-purple-700 dark:text-purple-300 border border-purple-100 dark:border-purple-900/30">
                                                Pertemuan <?php echo e($m->pertemuan_ke); ?>

                                            </span>
                                            <?php if(isset($m->kategori)): ?>
                                    ...
                                    <div class="flex items-center justify-between md:justify-end gap-4 border-t md:border-t-0 pt-3 md:pt-0 border-gray-100 dark:border-slate-800 flex-shrink-0">
                                        ...
                                        <div class="flex flex-col gap-1.5 min-w-[150px] max-w-[200px]">
                                            <?php $__empty_1 = true; $__currentLoopData = $m->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <a href="<?php echo e(route('dosen.materi.buka', [$kelas->id, $m->id, $file->id])); ?>"
                                                ...
                                                title="<?php echo e($file->nama_asli); ?>">
                                                    ...
                                                    <span class="truncate text-[11px] font-semibold"><?php echo e($file->nama_asli ?? 'Unduh File'); ?></span>
                                                </a>
                                        ...
                                        <div class="relative">
                                            <button type="button" onclick="toggleMateriDropdown('dropdownMateri<?php echo e($m->id); ?>')"
                                            ...
                                            <div id="dropdownMateri<?php echo e($m->id); ?>"
                                                ...
                                                <button type="button"
                                                        onclick="toggleMateriModal('modalEditMateri<?php echo e($m->id); ?>'); toggleMateriDropdown('dropdownMateri<?php echo e($m->id); ?>')"
                                                ...
                                                <form action="<?php echo e(route('dosen.kelas-materi.hapus', [$kelas->id, $m->id])); ?>" method="POST"
                                                    onsubmit="return confirm('Hapus materi &quot;<?php echo e($m->judul); ?>&quot;? Semua file yang terlampir juga akan terhapus.');">
                                                    <?php echo csrf_field(); ?>
            ...
            <?php $__currentLoopData = $materiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div id="modalEditMateri<?php echo e($m->id); ?>" class="fixed inset-0 z-50 hidden overflow-y-auto">
                    <div class="fixed inset-0 bg-black bg-opacity-40 transition-opacity" onclick="toggleMateriModal('modalEditMateri<?php echo e($m->id); ?>')"></div>
                    ...
                    <div class="relative min-h-screen flex items-center justify-center p-4">
                        <div class="relative bg-white dark:bg-slate-800 w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden">
                            ...
                            <form action="<?php echo e(route('dosen.kelas-materi.update', [$kelas->id, $m->id])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <div class="px-8 py-6 space-y-5">
                                    <div class="space-y-1.5">
                                        <label class="text-sm font-bold text-slate-700 dark:text-slate-300">Judul Materi</label>
                                        <input type="text" name="judul" value="<?php echo e($m->judul); ?>" required maxlength="255"
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="relative">
                                            <select name="pertemuan_ke" required class="w-full px-4 py-2.5 border border-gray-200 dark:border-slate-700 rounded-xl text-sm appearance-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-purple-500 focus:outline-none transition text-gray-500 dark:text-gray-300 bg-white dark:bg-slate-900 font-semibold">
                                                <?php for($i = 1; $i <= 16; $i++): ?>
                                                    <option value="<?php echo e($i); ?>" <?php if($m->pertemuan_ke === $i): echo 'selected'; endif; ?> class="dark:bg-slate-900">Minggu Ke-<?php echo e($i); ?></option>
                                                <?php endfor; ?>
                                            </select>
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <textarea name="deskripsi" rows="4" maxlength="5000"
                                            class="w-full px-4 py-3 border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-purple-500 focus:outline-none resize-none transition text-gray-800 dark:text-gray-100"><?php echo e($m->deskripsi); ?></textarea>
                                    </div>
                                        ...
                                        <div class="space-y-2">
                                            <?php $__empty_1 = true; $__currentLoopData = $m->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="flex items-center justify-between p-2 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700">
                                                    <span class="text-xs font-semibold truncate max-w-[200px] text-gray-700 dark:text-slate-300"><?php echo e($file->nama_asli); ?></span>
                                                    <label class="inline-flex items-center gap-1 text-xs text-red-600 cursor-pointer">
                                                        <input type="checkbox" name="hapus_files[]" value="<?php echo e($file->id); ?>" class="rounded text-red-600 focus:ring-red-500">
                                                        Hapus
                                                    </label>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                ...
                                <div class="bg-gray-50/70 dark:bg-slate-900 px-8 py-4 border-t border-gray-100 dark:border-slate-800 flex justify-end gap-3">
                                    <button type="button" onclick="toggleMateriModal('modalEditMateri<?php echo e($m->id); ?>')" class="px-5 py-2 rounded-lg border border-gray-200 dark:border-slate-700 text-sm font-semibold text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800 transition">
                                        Batal
                                    </button>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5 shadow-sm transition-colors duration-200">
                ...
                <p class="text-sm text-gray-600 dark:text-slate-300"><?php echo e($kelas->mataKuliah->deskripsi ?? 'Belum ada deskripsi untuk mata kuliah ini.'); ?></p>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex items-center justify-between text-xs text-gray-500 dark:text-slate-400 mb-1">
                            ...
                            <span class="font-bold text-gray-800 dark:text-white"><?php echo e($kelas->mahasiswa->count()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="modalMateri" class="fixed inset-0 z-50 hidden overflow-y-auto">
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white dark:bg-slate-800 w-full max-w-3xl rounded-2xl shadow-xl overflow-hidden">
                ...
                <form action="<?php echo e(route('dosen.kelas-materi.store', $kelas->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="px-8 py-6 space-y-5">

                        <div class="space-y-1.5">
                            <label class="text-sm font-bold text-slate-700 dark:text-slate-300">Judul Materi</label>
                            <input type="text" name="judul" value="<?php echo e(old('judul')); ?>" required maxlength="255" placeholder="Contoh: Pengenalan Struktur Data Lanjut" class="w-full px-4 py-2.5 border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-purple-500 focus:outline-none transition placeholder-gray-300 dark:placeholder-gray-600 text-gray-800 dark:text-gray-100 font-medium">
                        </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    <select name="pertemuan_ke" required class="w-full px-4 py-2.5 border border-gray-200 dark:border-slate-700 rounded-xl text-sm appearance-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-purple-500 focus:outline-none transition text-gray-500 dark:text-gray-300 bg-white dark:bg-slate-900 font-semibold">
                                        ...
                                        <?php for($i = 1; $i <= 16; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if((int) old('pertemuan_ke') === $i): echo 'selected'; endif; ?> class="dark:bg-slate-900">Minggu Ke-<?php echo e($i); ?></option>
                                        <?php endfor; ?>
                                    </select>
                                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-gray-400">
                                        <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
