...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="rounded-2xl bg-white border border-slate-200/80 p-4 shadow-sm">
        ...
        <p class="mt-2 text-3xl font-extrabold text-[#002B6B]">
            <?php echo e($rataRata ? number_format($rataRata, 1) : '-'); ?>

        </p>
        <p class="mt-1 text-xs text-gray-400">dari <?php echo e($totalKelas); ?> kelas</p>
    </div>
    ...
    <div class="rounded-2xl bg-white border border-slate-200/80 p-4 shadow-sm">
        ...
        <p class="mt-2 text-3xl font-extrabold text-emerald-600">
            <?php echo e($nilaiTertinggi ? number_format($nilaiTertinggi, 1) : '-'); ?>
    ...
    <div class="rounded-2xl bg-white border border-slate-200/80 p-4 shadow-sm">
        ...
        <p class="mt-2 text-3xl font-extrabold text-amber-500">
            <?php echo e($nilaiTerendah ? number_format($nilaiTerendah, 1) : '-'); ?>
    ...
    <div class="rounded-2xl bg-white border border-slate-200/80 p-4 shadow-sm">
        ...
        <p class="mt-2 text-3xl font-extrabold text-violet-600"><?php echo e($nilaiTugasList->count()); ?></p>
...
<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200/80 bg-white shadow-sm overflow-hidden">
        <div class="border-b border-slate-100 px-6 py-4 flex items-center justify-between">
            ...
            <span class="text-xs text-gray-400 font-semibold"><?php echo e($kelasList->count()); ?> Mata Pelajaran</span>
        </div>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-4 py-4 text-center font-medium text-slate-400"><?php echo e($index + 1); ?></td>
                                <td class="px-4 py-4 font-mono font-semibold text-slate-600"><?php echo e($kelas->mataKuliah?->kode_mk ?? '-'); ?></td>
                                <td class="px-4 py-4">
                                    <p class="font-bold text-slate-800 text-sm mb-0.5"><?php echo e($kelas->mataKuliah?->nama_mk ?? '-'); ?></p>
                                    <p class="text-[11px] text-gray-400"><?php echo e($kelas->dosen?->name ?? '-'); ?></p>
                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_kehadiran !== null ? number_format($nilai->nilai_kehadiran, 0) : '-'); ?>

                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_tugas !== null ? number_format($nilai->nilai_tugas, 0) : '-'); ?>

                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_quiz !== null ? number_format($nilai->nilai_quiz, 0) : '-'); ?>

                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_project !== null ? number_format($nilai->nilai_project, 0) : '-'); ?>

                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_uts !== null ? number_format($nilai->nilai_uts, 0) : '-'); ?>

                                </td>
                                <td class="px-3 py-4 text-center font-semibold text-slate-600">
                                    <?php echo e($nilai && $nilai->nilai_uas !== null ? number_format($nilai->nilai_uas, 0) : '-'); ?>

                                </td>
                                <td class="px-4 py-4 text-center font-bold text-slate-900 text-sm">
                                    <?php echo e($nilai && $nilai->nilai_akhir !== null ? number_format($nilai->nilai_akhir, 1) : '-'); ?>

                                </td>
                                <td class="px-4 py-4 text-center">
                                    <?php if($gc): ?>
                                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg <?php echo e($gc['bg']); ?> <?php echo e($gc['text']); ?> <?php echo e($gc['border']); ?> border text-xs font-extrabold shadow-sm">
                                            <?php echo e($grade); ?>
                                ...
                                <td class="px-4 py-4 max-w-[200px] truncate text-gray-500" title="<?php echo e($nilai?->catatan ?? ''); ?>">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="rounded-2xl bg-white border border-slate-200/80 p-5 shadow-sm">
            ...
            <?php if(empty($gradeDistribusi)): ?>
                <p class="text-xs text-gray-400 py-4 text-center">Belum ada data grade.</p>
            <?php else: ?>
                <div class="space-y-2.5">
                    <?php $__currentLoopData = ['A','AB','B','BC','C','D','E']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <?php if($count > 0): ?>
                            <div class="flex items-center gap-3">
                                <span class="w-8 h-8 rounded-lg <?php echo e($gc2['bg']); ?> <?php echo e($gc2['text']); ?> flex items-center justify-center text-xs font-extrabold shrink-0">
                                    <?php echo e($g); ?>

                                </span>
                                <div class="flex-1 min-w-0">
                                    <div class="h-2 rounded-full bg-gray-100 overflow-hidden">
                                        <div class="h-full rounded-full <?php echo e($gc2['bar']); ?>" style="width: <?php echo e($pct); ?>%"></div>
                                    </div>
                                </div>
                                <span class="text-xs font-bold text-gray-600 w-4 text-right"><?php echo e($count); ?></span>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="mt-4 pt-4 border-t border-gray-100 grid grid-cols-2 gap-3 text-center">
                    <div>
                        ...
                        <p class="text-xl font-extrabold text-[#002B6B] mt-1"><?php echo e($totalKelas); ?></p>
                    </div>
                    <div>
        ...
        <div class="rounded-2xl bg-white border border-slate-200/80 p-5 shadow-sm">
            ...
            <?php else: ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $nilaiTugasList->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tugas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $n = (float) $tugas->nilai;
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="shrink-0 w-10 h-10 rounded-xl <?php echo e($tugasGc['bg']); ?> <?php echo e($tugasGc['border']); ?> border flex items-center justify-center">
                                <span class="text-sm font-extrabold <?php echo e($tugasGc['text']); ?>"><?php echo e((int) $n); ?></span>
                            </div>

                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-semibold text-slate-700 truncate">
                                    <?php echo e($tugas->tugas?->judul ?? 'Tugas'); ?>

                                </p>
                                <p class="text-[10px] text-gray-400 truncate mt-0.5">
                                    <?php echo e($tugas->tugas?->kelasPerkuliahan?->mataKuliah?->nama_mk ?? '-'); ?>
                            ...
                            <div class="shrink-0 w-16">
                                <div class="h-1.5 w-full rounded-full bg-gray-100 overflow-hidden">
                                    <div class="h-full rounded-full <?php echo e($tugasGc['bar']); ?>" style="width: <?php echo e(min(100, $n)); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($nilaiTugasList->count() > 8): ?>
                    <p class="mt-3 text-center text-xs text-gray-400">
                        + <?php echo e($nilaiTugasList->count() - 8); ?> tugas lainnya
                    </p>
                <?php endif; ?>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cendekia\resources\views/mahasiswa/gradebook.blade.php ENDPATH**/ ?>