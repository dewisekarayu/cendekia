                    ...
                    <div class="p-2 sm:p-6">
                        <div class="grid grid-cols-7 gap-0.5 sm:gap-1 mb-2">
                            <?php $__currentLoopData = ['Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-center text-[9px] sm:text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-slate-500 py-1 sm:py-2 truncate"><?php echo e($day); ?></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
