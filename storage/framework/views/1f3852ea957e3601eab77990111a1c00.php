<?php $__env->startSection('title', $kelas->mataKuliah?->nama_mk ?? 'Detail Kelas'); ?>
    ...
    <div class="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div class="min-w-0">
            <div class="mb-2 flex flex-wrap items-center gap-2">
                <span class="rounded-lg border border-white/20 bg-white/15 px-2.5 py-1 text-xs font-bold text-white">
                    <?php echo e($kelas->mataKuliah?->kode_mk ?? '-'); ?>

                </span>
                <span class="text-xs text-purple-200/80"><?php echo e($kelas->semester?->nama_semester ?? 'Semester Aktif'); ?></span>
            </div>
            <h1 class="text-xl font-extrabold text-white sm:text-2xl"><?php echo e($kelas->mataKuliah?->nama_mk ?? 'Detail Kelas'); ?></h1>
            <p class="mt-1 text-sm text-purple-100/80">
                <?php echo e($kelas->hari); ?>, <?php echo e(substr($kelas->jam_mulai,0,5)); ?>–<?php echo e(substr($kelas->jam_selesai,0,5)); ?> · <?php echo e($kelas->ruangan ?? '-'); ?>
        ...
        <div class="shrink-0 flex flex-wrap gap-2">
            <span class="inline-flex items-center gap-1.5 rounded-xl border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white">
                ...
                <?php echo e($kelas->mahasiswa->count()); ?> mahasiswa
            </span>
        </div>
    </div>
</div>
...
<?php if($contextualHelp ?? null): ?>
    <?php echo $__env->make('help-center.contextual-help', array_merge($contextualHelp, ['dismissible' => true]), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="rounded-2xl border border-slate-200/80 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition-colors duration-200">
            ...
            <p class="text-sm leading-relaxed text-gray-600 dark:text-slate-300">
                <?php echo e($kelas->mataKuliah?->deskripsi ?? 'Belum ada deskripsi untuk mata kuliah ini.'); ?>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-2xl border border-slate-200/80 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm transition-colors duration-200">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('dosen.kelas-materi', $kelas->id)); ?>" class="flex items-center gap-2.5 rounded-xl border border-gray-100 dark:border-slate-700 p-3 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:border-[#321270] dark:hover:border-purple-500 hover:bg-purple-50/40 dark:hover:bg-purple-950/20 transition">
                    ...
                    <a href="<?php echo e(route('dosen.kelas-tugas', $kelas->id)); ?>" class="flex items-center gap-2.5 rounded-xl border border-gray-100 dark:border-slate-700 p-3 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:border-amber-400 dark:hover:border-amber-500 hover:bg-amber-50/40 dark:hover:bg-amber-950/20 transition">
                    ...
                    <a href="<?php echo e(route('dosen.gradebook', ['kelas_id' => $kelas->id])); ?>" class="flex items-center gap-2.5 rounded-xl border border-gray-100 dark:border-slate-700 p-3 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:border-emerald-400 dark:hover:border-emerald-500 hover:bg-emerald-50/40 dark:hover:bg-emerald-950/20 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Input Nilai
                    </a>
                    <a href="<?php echo e(route('dosen.absensi.index', $kelas->id)); ?>" class="flex items-center gap-2.5 rounded-xl border border-gray-100 dark:border-slate-700 p-3 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:border-blue-400 dark:hover:border-blue-500 hover:bg-blue-50/40 dark:hover:bg-blue-950/20 transition">
            ...
            <?php $__currentLoopData = [
                ...
                <div class="flex items-center gap-2.5">
                    <div class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#321270]/10 dark:bg-purple-950/40 text-[#321270] dark:text-purple-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($info['icon']); ?>"/></svg>
                    </div>
                    <div class="min-w-0">
                        <p class="text-[10px] text-gray-400 dark:text-slate-500"><?php echo e($info['label']); ?></p>
                        <p class="font-bold text-slate-700 dark:text-slate-200 truncate"><?php echo e($info['value']); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\cendekia\resources\views/dosen/kelas-detail.blade.php ENDPATH**/ ?>